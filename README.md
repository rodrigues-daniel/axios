...
- prometheus-addon: addon module, custom server and client side code 
- prometheus-ui: main application module
- prometheus-backend: backend module, contains any server side java code and dependencies
